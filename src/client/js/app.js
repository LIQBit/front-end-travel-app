...
const retrieveCityData = async (city) => {
    const geonamesURL = `https://secure.geonames.org/searchJSON?q=${city}&maxRows=1&username=${geonamesKey}`;
...
const updateUI = async () => {
    ...
    try{
        ...
        document.getElementById('arrival-condition').innerHTML = `Arrival: ${allData[allData.length - 2].arrival}`;
